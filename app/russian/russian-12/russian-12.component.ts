...
export class Russian12 {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['ю', 'к', 'е', 'у', 'а', 'ё', 'и', 'о', 'я', 'м', 'п', 'л', 'ж', 'д'];
    ...
    addEvent1() {
        ...
        const arrAlts = ['goat' ,'pencil', 'cow','cactus','whale','kiwi','cap','kangaroo'];
    ...
    addEvent2() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['ms','mz'];
        const arrAlts = ['hammer' ,'doll', 'mouse','raspberry','bear','mill','jellyfish','mimosa'];
    ...
    addEvent7() {
        ...
        const arrAlts = ['clod', 'pow', 'snake', 'pit', 'whirligig'];
    ...
    checkInp4() {
        let check = 0;
        const arr1 = ['яма', 'лапа', 'ком', 'уж', 'юла'];
