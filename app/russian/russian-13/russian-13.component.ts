...
export class Russian13 {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['ю', 'ж', 'л', 'п', 'м', 'я', 'о', 'и', 'а', 'ё', 'у', 'е', 'к', 'д'];
    ...
    addEvent1() {
        ...
        const arrAlts = ['onion' ,'moose', 'spoon','magnifier','foxM','wateringCan','lemon','frog'];
    ...
    addEvent4() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['b', 'a', 'b2', 'a2'];

        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                let target1 = event.target as HTMLElement;
                let index1 = i;
                if ((index1 == index2) || ((index1 == 0) && (index2 == 2)) || ((index1 == 1) && (index2 == 3))
                || ((index1 == 2) && (index2 == 0)) || ((index1 == 3) && (index2 == 1))) {
    ...
    addEvent8() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrDivs = ['КОМ','ЛАПА','УЖ','БАБА','БЕЛКА'];
        const arrAlts = ['clod', 'pow', 'snake','grandba', 'squirrel'];
    ...
    checkInp4() {
        let check = 0;
        const arr1 = ['баба', 'белка', 'жук', 'лук', 'лупа', 'дом', 'ёж'];
