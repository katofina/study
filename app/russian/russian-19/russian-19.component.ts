...
export class Russian19 {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['д', 'ж', 'л', 'к', 'и', 'у', 'ё', 'а', 'о', 'я', 'е', 'м', 'п', 'ю', 'н', 'б', 'г'];
    ...
    addEvent7() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['m', 'a', 'l', 'i', 'n', 'a2'];

        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                let target1 = event.target as HTMLElement;
                let index1 = i;
                if ((index1 == index2) ||((index1 == 1) && (index2 == 5)) ||((index1 == 5) && (index2 == 1))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['ян', 'ум', 'ёл', 'ок', 'пи', 'до', 'га', 'жу', 'ке', 'бе', 'ад', 'юл'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['гамак', 'белка', 'удод', 'панда', 'малина'];
