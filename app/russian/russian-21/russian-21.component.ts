...
@Component({
    selector: 'russian21',
    templateUrl: './russian-21.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian21 {
    viewDiv2() {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['д', 'ж', 'к', 'м', 'у', 'ё', 'а', 'и', 'о', 'я', 'е', 'п', 'л', 'ю', 'н', 'б', 'г'];
    ...
    addEvent1() {
        ...
        const arrAlts1 = ['ls','lz','yu','u'];
        const arrAlts = ['onion' ,'moose', 'spoon','magnifier','fox','wateringCan','frog','lemon','yurt','whirligig','seaCadet','skirt', 'snail', 'duck', 'hoopoe','rod'];
    ...
    addEvent2() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['gs','gz','j','m'];
        const arrAlts = ['mountain' ,'jackdaw', 'pigeon','dwarf','hyena','kettlebell','dahilas','guitar','giraffe','toad','beatle','crane', 'bear', 'jellyfish', 'mill','mimosa'];
    ...
    addEvent3() {
        ...
        const arrAlts = ['catfish' ,'rope', 'plane','saber','heart','net','drake','titmouse'];
    ...
    addEvent6() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['s', 'k', 'a', 'k2', 'a2', 'l', 'k3', 'a3'];

        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                let target1 = event.target as HTMLElement;
                let index1 = i;
                if ((index1 == index2) || ((index1 == 2) && (index2 == 4)) || ((index1 == 2) && (index2 == 7)) ||
                ((index1 == 4) && (index2 == 2)) || ((index1 == 4) && (index2 == 7)) ||
                ((index1 == 7) && (index2 == 2)) || ((index1 == 7) && (index2 == 4)) ||
                ((index1 == 1) && (index2 == 3)) || ((index1 == 1) && (index2 == 6)) ||
                ((index1 == 3) && (index2 == 1)) || ((index1 == 3) && (index2 == 6)) ||
                ((index1 == 6) && (index2 == 1)) || ((index1 == 6) && (index2 == 3))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['сом', 'си', 'ост', 'ос', 'сов', 'бас', 'мис', 'лес', 'сел', 'ус', 'сил', 'лис'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['сабля', 'сом', 'скакалка', 'ослик', 'мак'];
