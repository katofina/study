...
@Component({
    selector: 'russian24',
    templateUrl: './russian-24.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian24 {
    viewDiv2() {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['т', 'г', 'н', 'д', 'ж', 'п', 'м', 'я', 'о', 'у', 'ё', 'а', 'и', 'е', 'к', 'л', 'ю', 'б', 'с'];
    ...
    addEvent2() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['bs','bz','ps','pz'];
        const arrAlts = ['banana' ,'drum', 'ram','barrel','ticket','hippopotamus','runner','squirrel','pig','sunflower','panda','parrot', 'penguin', 'pelican', 'gun','cock'];
    ...
    addEvent9() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['r', 'yu', 'k', 'z', 'a', 'k2'];

        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                let target1 = event.target as HTMLElement;
                let index1 = i;
                if ((index1 == index2) || ((index1 == 2) && (index2 == 5)) || ((index1 == 5) && (index2 == 2))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    addEvent10() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['r', 'u', 's', 'a', 'l', 'k', 'a2'];

        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                let target1 = event.target as HTMLElement;
                let index1 = i;
                if ((index1 == index2) || ((index1 == 3) && (index2 == 6)) || ((index1 == 6) && (index2 == 3))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['ром', 'рот', 'бум', 'раз', 'рёв', 'роб', 'бор', 'ор', 'ре', 'ру', 'бур', 'жор'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['сорока', 'рак', 'робот', 'редиска', 'репа', 'роза', 'русалка', 'рюкзак'];
