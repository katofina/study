...
@Component({
    selector: 'russian26',
    templateUrl: './russian-26.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian26 {
    viewDiv2() {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['в', 'зс', 'б', 'н', 'дт', 'ж', 'гк', 'бп', 'м', 'р', 'ая', 'оё', 'ую', 'и', 'е', 'л'];
    ...
    addEvent7() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['sh', 'i', 'p', 'o', 'v', 'n', 'i2', 'k'];

        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                let target1 = event.target as HTMLElement;
                let index1 = i;
                if ((index1 == index2) || ((index1 == 1) && (index2 == 6)) || ((index1 == 6) && (index2 == 1))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    addEvent8() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['sh', 'e', 's', 't', 'e2', 'r', 'yo', 'n', 'k', 'i'];
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['яш', 'туш', 'юш', 'шёл', 'иш', 'лош', 'шил', 'шар', 'ваш', 'душ', 'пеш', 'ваш'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['шило', 'шапка', 'шалаш', 'шиповник', 'шишка', 'шестерёнки', 'шар', 'шарик'];
