...
@Component({
    selector: 'russian27',
    templateUrl: './russian-27.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian27 {
    viewDiv2() {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['зс', 'н', 'л', 'гк', 'бп', 'м', 'и', 'ую', 'ая', 'оё', 'р', 'е', 'жш', 'дт'];
    ...
    addEvent1() {
        ...
        const arrAlts1 = ['sh','j'];
        const arrAlts = ['gears' ,'rosehip', 'baloon','furCoat', 'cone','giraffe','beatle','acorns','frog', 'crane'];
    ...
    addEvent2() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['gs','gz','ks','kz'];
        const arrAlts = ['jackdaw' ,'pigeon', 'goose','dwarf','guitar','kettlebell','hyena','dahlias','cuckoo','cow','goat','cat', 'whale', 'cap', 'pickaxe','kangaroo'];
    ...
    addEvent3() {
        ...
        let target: HTMLElement;
        const arrAlts1 = ['ei','e'];
        const arrAlts = ['popsicle' ,'excavator', 'escalator','eclair', 'emu','meal','echidna','unicorn','blackberry', 'racoon'];
    ...
    addEvent7() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['e', 'k', 's', 'k2', 'a', 'v', 'a2', 't', 'o', 'r'];
        ...
        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                ...
                || ((index1 == 4) && (index2 == 6)) || ((index1 == 6) && (index2 == 4))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    addEvent8() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['e', 's', 'k', 'a', 'l', 'a2', 't', 'o', 'r'];

        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                let target1 = event.target as HTMLElement;
                let index1 = i;
                if ((index1 == index2) || ((index1 == 3) && (index2 == 5)) || ((index1 == 5) && (index2 == 3))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['эм', 'эн', 'эр', 'сэт', 'сет', 'мэ', 'ме', 'дэ', 'де', 'эл', 'вэл', 'вел'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['мак', 'дом', 'эскимо', 'эму', 'эклер', 'кит', 'лиса', 'рак'];
