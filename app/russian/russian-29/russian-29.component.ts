...
@Component({
    selector: 'russian29',
    templateUrl: './russian-29.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian29 {
    viewDiv2() {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['ч', 'дт', 'жш', 'гк', 'бп', 'е', 'ую', 'оё', 'ая', 'и', 'р', 'м', 'л', 'н', 'зс'];
    ...
    addEvent2() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['ms','mz','ns','nz'];
        const arrAlts = ['doll' ,'poppy', 'mouse','flyAgaric','bear','ball','mimosa','mill','rhino','daffodil','mink','burbot', 'ignoramus', 'tumbler', 'forgetmenot','thread'];
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['це', 'ца', 'цу', 'оц', 'уц', 'ци', 'цо', 'юц', 'эц', 'ец', 'ац', 'яц'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['мишка', 'цесарка', 'цирк', 'циркач', 'цапля', 'цветок', 'мышка', 'шишка'];
