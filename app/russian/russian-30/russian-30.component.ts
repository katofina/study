...
@Component({
    selector: 'russian30',
    templateUrl: './russian-30.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian30 {
    viewDiv2() {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['ц', 'ч', 'зс', 'н', 'дт', 'жш', 'л', 'гк', 'бп', 'е', 'и', 'ую', 'ая', 'оё', 'р', 'м'];
    ...
    addEvent1() {
        ...
        const arrAlts1 = ['c','t'];
        const arrAlts = ['heron' ,'pintado', 'circus','circusPerformer', 'cicada','tulip','phone','TV','blackGrose', 'tiger'];
    ...
    addEvent5() {
        ...
        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                ...
                || ((index1 == 3) && (index2 == 1)) || ((index1 == 3) && (index2 == 5)) ||
                ((index1 == 5) && (index2 == 1)) || ((index1 == 5) && (index2 == 3))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    addEvent6() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['f', 'u', 't', 'b', 'o', 'l', 'i', 's', 't2'];

        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                let target1 = event.target as HTMLElement;
                let index1 = i;
                if ((index1 == index2) || ((index1 == 2) && (index2 == 8)) || ((index1 == 8) && (index2 == 2))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['фе', 'фа', 'фу', 'оф', 'уф', 'фи', 'фо', 'юф', 'эф', 'еф', 'аф', 'яф'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['футболист', 'финики', 'фея', 'филин', 'фламинго', 'ворона', 'волк', 'банан'];
