...
@Component({
    selector: 'russian31',
    templateUrl: './russian-31.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian31 {
    viewDiv2() {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['ф', 'ч', 'зс', 'жш', 'л', 'гк', 'бп', 'м', 'р', 'и', 'ую', 'ая', 'оё', 'е', 'дт', 'н', 'ц'];
    ...
    addEvent1() {
        ...
        const arrAlts1 = ['fs','fz'];
        const arrAlts = ['magician' ,'fountain', 'hazelnuts','flamingo', 'camera','violets','dates','fairy','ficus', 'owl'];
    ...
    addEvent2() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['ls','lz','rs','rz'];
        const arrAlts = ['lama' ,'ski', 'swallow','lilies','moon','toad','ruler','lily','leopard','lion','crayfish','rocket', 'chamomile', 'rainbow', 'rose',
        'belt','backpack','turnip','radish','child'];
        ...
        imgs1.forEach(function(img) {
            img.addEventListener('click', (event) => {
                ...
                let alt = target2.getAttribute('alt');
                let index = arrAlts1.indexOf(alt!);
                if (((index == 0) && (index2 < 5)) || ((index == 1) && (index2 > 4) && (index2 < 10)) || ((index == 2) && (index2 > 9) && (index2 < 15))
                || ((index == 3) && (index2 > 14))) {
                    target2.style.border = '3px solid green';
                    setTimeout(() => target2.style.border = '1px solid black', 200)
                    target.remove();
    ...
    addEvent3() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['hs','hz'];
        const arrAlts = ['husky' ,'ferret', 'hamster','fridge', 'bread','hockey','trunk','bathrobe','persimmon','hut', 'heck'];
    ...
    addEvent7() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['h', 'o', 'ks', 'kz', 'e', 'i', 's', 't'];
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['хе', 'ха', 'ху', 'ох', 'ух', 'хи', 'хо', 'юх', 'эх', 'ех', 'ах', 'ях'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['хорёк', 'хоккеист', 'хижина', 'хлеб', 'хомяк', 'баран', 'мяч', 'ворон'];
