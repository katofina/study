...
@Component({
    selector: 'russian32',
    templateUrl: './russian-32.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian32 {
    viewDiv2() {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['х', 'ц', 'ч', 'н', 'жш', 'м', 'еэ', 'р', 'ую', 'ая', 'оё', 'и', 'бп', 'гк', 'л', 'дт', 'зс', 'вф'];
    ...
    addEvent2() {
        ...
        const arrAlts = ['jackdaw' ,'pigeon', 'goose','dwarf','guitar','kettlebell','hyena','dahlias','cat','goat','cow','cuckoo', 'whale', 'cap', 'pickaxe','kangaroo'];
    ...
    addEvent3() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['y','y2','y3'];
        const arrAlts = ['yoga' ,'yoghurt', 'york','iodine','rabbit','wateringCan','teapot','seagull','nightingale','hive','parrot','tea'];
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['ай', 'ой', 'уй', 'ей', 'яй', 'эй', 'лей', 'мой', 'ной', 'зной', 'той', 'стой'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['йорк', 'гном', 'волк', 'ананас', 'зайчик', 'чайка', 'чай', 'чайник'];
