...
@Component({
    selector: 'russian33',
    templateUrl: './russian-33.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian33 {
    viewDiv2() {
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['х', 'вф', 'ц', 'ч', 'л', 'и', 'ая', 'оё', 'ую', 'р', 'еэ', 'м', 'бп', 'гк', 'жш', 'дт', 'н', 'зс'];
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['ящ', 'ща', 'щу', 'борщ', 'хвощ', 'щит', 'щи', 'ющ', 'ущ', 'гущ', 'щур', 'щер'];
