...
@Component({
    selector: 'russian38',
    templateUrl: './russian-38.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian38 {
    viewDiv2() {
    ...
    addEvent10() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['p', 'o', 'r', 'o2', 's', 'yo', 'n', 'o3', 'k'];
        ...
        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                ...
                || ((index1 == 1) &&  (index2 == 7)) || ((index1 == 3) && (index2 == 7)) || ((index1 == 7) && 
                (index2 == 1)) || ((index1 == 7) && (index2 == 3))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['кол', 'гол', 'вол', 'соль', 'зола', 'вода', 'слон', 'куб', 'зуб', 'бук', 'бык', 'бок'];
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['бук', 'груша', 'ёжик', 'лягушка', 'поросёнок', 'бобёр', 'бык', 'зубр'];
