...
export class Russian4 {
    ...
    addEvent1() {
        ...
        const arrAlts1 = ['p','m','ya','i', 'o'];
        const arrAlts = ['bubble', 'ball', 'anchor', 'turkey', 'wasps'];
    ...
    addEvent2() {
        ...
        const arrAlts = ['duck', 'lizzard', 'indian', 'hoop', 'bus'];
    ...
    addEvent3() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['ms','ks','ps','mz','kz','pz'];
        const arrAlts = ['mouse', 'cat', 'panda', 'bear', 'whale', 'penguin'];
    ...
    addEvent5() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['k', 'a', 'p','dash'];

        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                let target1 = event.target as HTMLElement;
                let index1 = i;
                if ((index1 == index2) || ((index1 == 4) && (index2 == 0)) || ((index1 == 5) && (index2 == 1))
                || ((index1 == 6) && (index2 == 2))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
    ...
    addEvent6() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['ya', 'heart', 'm1','a','m2','u', 'dot'];

        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                let target1 = event.target as HTMLElement;
                let index1 = i;
                if ((index1 == index2) || ((index1 == 2) && (index2 == 4)) || ((index1 == 4) && (index2 == 2))) {
                    target.style.border = 'none';
                    target1.parentElement!.style.border = '3px solid green';
                    target1.append(target);
                };
    ...
    addEvent7() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['ya', 'heart', 'p1','a','p2','u', 'dot'];
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['лупа', 'мяу', 'кап-кап', 'лапа'];
    ...
    addEvent8() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrDivs = ['ЛАПА','ЛУПА','КАП-КАП','МЯУ'];
        const arrAlts = ['paw', 'magnifier', 'rain', 'cat'];
