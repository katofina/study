...
@Component({
    selector: 'russian41',
    templateUrl: './russian-41.component.html',
...
export class Russian41 {
    ...
    addEvent2() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['j', 'y', 'l', 'z', 'b', 'g', 'k', 'm', 'v', 'd'];
    ...
    addEvent3() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['a', 'b', 'v', 'g', 'd', 'e', 'yo', 'j', 'z', 'i', 'y', 'k', 'l', 'm'];
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['гном', 'гномик', 'ёж', 'ёжик', 'нож', 'ножик', 'нос', 'носик', 'глаз', 'глазик', 'ноль', 'нолик'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['кран', 'краник', 'зонт', 'зонтик', 'кот', 'котик', 'слон', 'слоник', 'гвоздь', 'гвоздик', 'дом', 'домик'];
