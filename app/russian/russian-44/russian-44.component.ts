...
@Component({
    selector: 'russian44',
    templateUrl: './russian-44.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian44 {
    viewDiv2() {
    ...
    addEvent1() {
        ...
        const arrAlts = ['d', 'j', 'v', 'k', 'g', 'y', 'l', 'b', 'm', 'e', 'yu', 'a', 'yo', 'o', 'i', 'eiy', 'ya', 'ei'];
    ...
    addEvent2() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['a', 'b', 'g', 'e', 'j', 'i', 'k', 'm', 'r', 't', 'f', 'c', 'sh', 'sha', 'iy', 'eiy', 'iye', 'ei', 'ya'];
    ...
    addEvent3() {
        const divs = document.getElementById('div9')!.getElementsByClassName('divInDivABC');
        const imgs = document.getElementById('div9')!.querySelectorAll('img')!;
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['a', 'g', 'e', 'z', 'y', 'l', 'n', 'p', 's', 'h', 'yi', 'yei', 'ya'];
    ...
    addEvent4() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['t', 'sh', 'p', 'f', 'h', 'sha', 's', 'ch', 'y', 'd', 'g', 'm', 'v', 'b', 'z', 'l', 'j', 'n'];
        ...
        for (let i = 0; i < divs.length; i++) {
            divs[i].addEventListener('click', (event) => {
                ...
                if (((index1 === 0) && (index2 <= 7)) || ((index1 === 1) && (index2 >= 8))) {
                    target.style.border = 'none';
                    target1.style.border = '3px solid green';
                    setTimeout(() => target1.style.border = '3px solid blsck', 300)
                    target.remove();
                };
        })
        };
    ...
    addEvent5() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts = ['ya', 'iye', 'ch', 'h', 'u', 's', 'p', 'o', 'm', 'y', 'z', 'yo', 'iy','e', 'a'];
    ...
    checkInp4() {
        let check = 0;
        const arr1 = ['ослёнок', 'зубрёнок', 'зайчёнок', 'лисёнок', 'волчёнок', 'тигрёнок', 'медвежёнок', 'козлёнок'];
