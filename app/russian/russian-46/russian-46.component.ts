...
export class Russian46 {
    ...
    addEvent1() {
        ...
        const arrAlts1: Array<string> = ['yo','ya','e','i','yu'];
        const arrAlts: string[] = ['o' ,'a', 'ei','eiy','u'];
    ...
    addEvent2() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts: Array<string> = ['bus', 'crow', 'crane', 'iguana', 'crocodile', 'lion', 'ant', 
        'donkey', 'tiger'];
    ...
    addEvent5() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts: string[] = ['jaguar', 'penguin', 'bear', 'lion', 'giraffe', 'wolf', 'ram'];
    ...
    checkInp1() {
        let check = 0;
        const arr1: string[] = ['волк', 'волчица', 'волчёнок', 'лев', 'львица', 'львёнок', 'лис', 'лиса', 'лисёнок', 'бык', 'корова', 'телёнок'];
    ...
    addEvent6() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts: string[] = ['l', 'ya', 'g', 'u', 'sh', 'a', 't'];
    ...
    addEvent7() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts: Array<string> = ['b', 'r', 'o', 's', 'i', 't', 'iy', 's2', 'ya'];
    ...
    addEvent8() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts: string[] = ['c', 'a', 'p', 'l', 'i'];
    ...
    addEvent9() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts: string[] = ['s', 'm', 'e', 'sh', 'a', 't'];
    ...
    addEvent11() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts: string[] = ['b', 'o', 'yu', 's', 'y'];
    ...
    checkInp2() {
        let check = 0;
        const arr1: Array<string> = ['туча', 'тучка', 'ковёр', 'коврик', 'кровать', 'кроватка', 
        'подушка', 'подушечка', 'корзина', 'корзиночка', 'ягода', 'ягодка'];
