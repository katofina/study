...
@Component({
    selector: 'russian49',
    templateUrl: './russian-49.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian49 {
    a = 0;
    b = 0;
    ...
    addEvent1() {
        ...
        const arrAlts = ['ch', 'y', 't', 'k', 'm', 'sha', 'l', 'b', 'f', 'p', 'c', 'm', 'p', 'r', 'd', 'k', 'sh', 'g'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['чемодан', 'белочка', 'ежевика', 'дрозд', 'курочка', 'козочка', 'куколка', 'лилия'];
