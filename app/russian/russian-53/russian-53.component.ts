...
@Component({
    selector: 'russian53',
    templateUrl: './russian-53.component.html',
    styleUrls: ['../russian-1/russian-1.component.scss']
})

export class Russian53 {
    select1 = false;
    select2 = false;
    select3 = false;
    select4 = false;
    ...
    addEvent1() {
        ...
        const arrAlts1 = ['dyi','ka','mya','lam','kan','za'];
        const arrAlts = ['nya' ,'ruch', 'chik','pa','sta','ro'];
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['глубина', 'глубокий', 'мелкий', 'высота', 'высокий', 'низкий', 'ширина', 'широкий', 'узкий', 'толщина', 'толстый', 'узкий'];
