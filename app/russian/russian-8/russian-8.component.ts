...
export class Russian8 {
    ...
    addEvent2() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['u','i','a', 'yo'];
        const arrAlts = ['udod', 'turkey', 'bus', 'tree'];
    ...
    addEvent4() {
        ...
        let index2: any;
        let target: HTMLElement;
        const arrAlts1 = ['e','ya','o','yo'];
        const arrAlts = ['racoon', 'lamb', 'donkey','ruff'];
    ...
    addEvent8() {
        ...
        let target: HTMLElement;
        const arrAlts1 = ['ls','ms','lz','mz'];
        const arrAlts = ['moose', 'matryoshka', 'wateringCan', 'daisy'];
    ...
    addEvent9() {
        ...
        let target: HTMLElement;
        const arrAlts1 = ['j','m'];
        const arrAlts = ['beatle' ,'toad', 'crane','giraffe','jellyfish','bear','daisy', 'mill'];
    ...
    checkInp1() {
        let check = 0;
        const arr1 = ['ж', 'е', 'я', 'и', 'а', 'ё', 'у', 'о', 'м', 'п', 'к','л'];
    ...
    checkInp2() {
        let check = 0;
        const arr1 = ['папа', 'молоко', 'мяу', 'мама', 'ёж'];
    ...
    checkInp3() {
        let check = 0;
        const arr1 = ['ж', 'е', 'ё', 'ко-ко', 'му', 'ёж', 'ку-ку', 'кап-кап'];
        const arr2 = document.getElementById('div25')!.querySelectorAll('input');
        const arr3: string[] = [];
        arr2.forEach (function(el) {
            arr3.push(el.value.toLowerCase());
